...
int main(void)
{
    ...
    while (1) 
    {
    	...
    	GPIO_STM32.rgb.g_on();		//Verde
    	GPIO_STM32.rgb.b_off();
    	SYSCLK_STM32.delay_ms(1000); //Delay de 500ms
    	GPIO_STM32.rgb.r_off();
    	GPIO_STM32.rgb.g_off();		//Azul
    	GPIO_STM32.rgb.b_on();
    	SYSCLK_STM32.delay_ms(1000); //Delay de 500ms
    	GPIO_STM32.rgb.r_off();
    	GPIO_STM32.rgb.g_on();		//Cian
    	GPIO_STM32.rgb.b_on();
    	SYSCLK_STM32.delay_ms(1000); //Delay de 500ms
    	GPIO_STM32.rgb.r_on();
    	GPIO_STM32.rgb.g_off();		//Magenta
    	GPIO_STM32.rgb.b_on();
    	SYSCLK_STM32.delay_ms(1000); //Delay de 500ms
    	GPIO_STM32.rgb.r_on();
    	GPIO_STM32.rgb.g_on();		//Amarillo
    	GPIO_STM32.rgb.b_off();
    	SYSCLK_STM32.delay_ms(1000); //Delay de 500ms
    	GPIO_STM32.rgb.r_on();
    	GPIO_STM32.rgb.g_on();		//Blanco
    	GPIO_STM32.rgb.b_on();
    	SYSCLK_STM32.delay_ms(1000); //Delay de 500ms
		*/
    	/*------ Practica 2 ------*//*
